  ...
  return (
    <div className="pv">
      ...
      <section className="wrap" style={{ paddingTop: 66 }}>
        ...
        <p className="sub">Y cuando por fin está lista, la planilla queda huérfana: el certificado
          se rehace, el plazo se estima aparte, la cobranza vive en otro archivo.</p>
        <div className="comp">
          <div className="col no">
            <h3>Con planillas sueltas</h3>
            <ul>
              <li>Días armando un presupuesto desde cero, ítem por ítem</li>
              ...
              <li>Un adicional obliga a rehacer medio archivo</li>
